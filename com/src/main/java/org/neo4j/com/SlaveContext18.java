 ...
 */
public final class SlaveContext18 implements SlaveContext
{
    ...
    public SlaveContext18( long sessionId, int machineId, int eventIdentifier,
    ...
    {
        if ( !( obj instanceof SlaveContext18 ) )
        {
            return false;
        }
        SlaveContext18 o = (SlaveContext18) obj;
    ...
    public static SlaveContext EMPTY = new SlaveContext18( -1, -1, -1, new Tx[0], -1, -1 );

    public static SlaveContext anonymous( Tx[] lastAppliedTransactions )
    {
        SlaveContext18 castedEmpty = (SlaveContext18) EMPTY;
        return new SlaveContext18( castedEmpty.sessionId, castedEmpty.machineId, castedEmpty.eventIdentifier,
