...
import static org.neo4j.com.Protocol18.INTEGER_SERIALIZER;
import static org.neo4j.com.Protocol18.LONG_SERIALIZER;
import static org.neo4j.com.Protocol18.VOID_SERIALIZER;
import static org.neo4j.com.Protocol18.readBoolean;
...
public enum HaRequestType153 implements RequestType<Master>
{
    ...
    private <T> HaRequestType153( MasterCaller caller, ObjectSerializer<T> serializer, boolean includesSlaveContext )
    {
        this.caller = caller;
